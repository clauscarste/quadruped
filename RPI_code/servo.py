...
def set_angle(servo_angle1, servo_angle2, servo_angle3,ofsets):
    ...
    servo_angle1 = servo_angle1 - ofsets[1]
    servo_angle2 = servo_angle2 - ofsets[2]
    servo_angle3 = servo_angle3 - ofsets[3]
    ...
    pwm.set_pwm(0,0,round(m[1],0))
    pwm.set_pwm(1,0,round(m[2],0))
    pwm.set_pwm(2,0,round(m[3],0))
